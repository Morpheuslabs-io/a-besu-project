...
/opt/besu-21.1.2/bin/besu --data-path $NODE_FOLDER/$keypairDataFolder --genesis-file=$NODE_FOLDER/genesis.json --config-file=$NODE_FOLDER/$tomlConfigFile --p2p-port=$P2P_PORT --p2p-host=$P2P_HOST --rpc-http-port=$RPC_PORT --bootnodes=$BOOT_NODE_1_ENODE &